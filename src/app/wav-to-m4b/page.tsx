...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Drop your WAV files and get a single chaptered M4B audiobook out. Runs entirely in your browser via WebAssembly — your audio never leaves your device.',
  },
  twitter: {
    card: 'summary',
    title: 'WAV to M4B Converter — Free, Private, No Upload',
...
const FAQS = [
  {
    ...
    a: 'WAV stores uncompressed PCM audio, which is very large. The M4B output uses AAC at 64 kbps — the standard for spoken-word audiobooks — which is roughly 15–20× smaller with no audible difference for speech. A 1 GB WAV audiobook typically becomes a 60–80 MB M4B.',
  },
  {
